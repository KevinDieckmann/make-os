...
export function wochenScoreboard(kontakte: Kontakt[], crm: CrmBestand, heute: string, wochen = 8): Scoreboard {
  ...
  const spez: Spez[] = [
    ...
    ...personen('gespraeche'),
    { id: 'neue_chancen', welt: 'sales', label: 'Neue Chancen', ziel: SCORE_ZIELE.neue_chancen, gelbAb: null, quelle: 'angelegte Chancen', ab: abChance, zaehle: anzahl(chancen, c => tag(c.angelegt)) },
    { id: 'gewonnen', welt: 'sales', label: 'Gewonnene Chancen', ziel: null, gelbAb: null, quelle: 'Stufe „gewonnen“ in der Historie', ab: abChance,
