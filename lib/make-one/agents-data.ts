...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    agents: [
      ...
      { id: 'crm', name: 'CRM-/Pipeline-Agent', role: 'Wer ist heute dran — Tagesliste, Pipeline, Wiedervorlagen', status: 'live', autonomy: 'entwurf', model: 'ausgewogen', gate: 'Versand ✋', href: '/os/markttraktion?s=sales',
      ...
      { id: 'head-sales', name: 'Head of Sales', role: 'Vertrieb und Kundenbetreuung — Power Hour vorbereiten, Deal- und Kundenreview, Vorschläge zur Freigabe', status: 'live', autonomy: 'vorschlag', model: 'stark', href: '/os/markttraktion?s=sales',
        ...
        bauplan: 'LIVE (24.09.): lib/heads/ — Datenpaket aus Kartei + CRM (Code rechnet), Prompt nach Recherche, Prüfer streicht erfundene IDs, unzulässige Kanäle, Werbesperren und Vollzug; Freigabe-Liste mit Dedup. → /os/markttraktion?s=sales' },
  ...
  },
  {
    ...
    agents: [
      { id: 'head-marketing', name: 'Head of Marketing', role: 'Ansprechbar sein statt laut — Einwilligungen, Fristen, Themen aus Kundengesprächen', status: 'live', autonomy: 'vorschlag', model: 'ausgewogen', href: '/os/markttraktion?s=marketing',
        ...
        bauplan: 'LIVE (24.09.): lib/heads/ (gemeinsamer Rahmen mit Sales und Event). → /os/markttraktion?s=marketing' },
      { id: 'head-event', name: 'Head of Event', role: 'Stammtische, Workshops, Dinner — Ziel, Gästemischung, Nachfassen in 48 h, Wirkung', status: 'live', autonomy: 'vorschlag', model: 'ausgewogen', href: '/os/markttraktion?s=event',
        ...
        bauplan: 'LIVE (24.09.): lib/heads/. → /os/markttraktion?s=event' },
