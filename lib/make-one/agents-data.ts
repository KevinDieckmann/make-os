  ...
  },
  {
    ...
    agents: [
      ...
      { id: 'crm', name: 'CRM-/Pipeline-Agent', role: 'Wer ist heute dran — Tagesliste, Pipeline, Wiedervorlagen', status: 'live', autonomy: 'entwurf', model: 'ausgewogen', gate: 'Versand ✋', href: '/os/crm',
        ...
        bauplan: 'LIVE seit 18.09.: /os/crm. Quelle ist die CRM_MASTER_Hauptdatei vom Schreibtisch; die Pipeline lebt nur hier und wird beim Abgleich nicht angefasst. Jarvis: suche_kontakt, notiere_kontakt, entwurf_ansprache. Kein Werkzeug zum Versenden — Kevin schickt selbst. Seit 24.09. mit Power Hour, Kanal-Ampel, Firmen und Stammdaten (lib/crm/); das Adressbuch der Kontakte-App bleibt bewusst draußen.' },
