...
import { Clock, Inbox, HeartPulse, ListChecks, BarChart3, Users, Settings } from 'lucide-react';
...
export const HAUPT: Eintrag[] = [
  ...
  { href: '/os/finanzen', label: 'Zahlen', icon: BarChart3, passt: ['/os/finanzen', '/os/controlling', '/os/performance', '/os/saeule'] },
