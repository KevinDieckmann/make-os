...
export function Marketing({ api, zuKontakt, start }: { api: CrmApi; zuKontakt: (id: string) => void; start?: string }) {
  ...
  return (
    <>
      ...
      <div style={{ overflowX: 'auto', scrollbarWidth: 'none' }}><Pillen einzeilig liste={liste} aktiv={unter} onWahl={setUnter} /></div>
