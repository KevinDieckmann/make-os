...
const EVENTS: KemarisEvent[] = [
  ...
  { id: 'ms-7', title: 'CapOS TownHall',      start: '2026-07-31T10:00:00', end: '2026-07-31T11:00:00', company: 'KEMARIS', source: 'microsoft-365', isTeams: true },
  ...
  { id: 'ms-11', title: 'Weekly CapOS',               start: '2026-08-03T14:00:00', end: '2026-08-03T15:00:00', company: 'KEMARIS', source: 'microsoft-365', isTeams: true },
];

export async function GET() {
  // Write-through in den Store — damit das Brain (Loops, Tageslauf, Jarvis)
  // die KEMARIS-Termine sieht, nicht nur diese eine Ansicht.
  try { await saveJson('kemaris-calendar', { events: EVENTS, at: LAST_UPDATED }); } catch { /* Anzeige geht vor */ }
  return NextResponse.json(
    { lastUpdated: LAST_UPDATED, events: EVENTS },
